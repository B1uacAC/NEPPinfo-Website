...
<div class="function-container">
    <div class="main-wrapper">
        <%
            ...
            session.setAttribute("object","videos");
        %>
        <div class="function">
            ...
            <div class="function-wrapper">
                <form action="manageServlet" method="post">
                    <div class="form-row">
                        <input type="text" name="type" value="videos" hidden>
                    </div>
                    <div class="form-row">
                        <label>选择操作:</label>
                        <select name="op">
                    ...
                    <div class="form-row">
                        <%
                            String sql2 = "select * from manager.videos";
        ...
        <div class="manage-list">
            <div class="list-container">
                <table>
                    ...
                    <%
                        String sql = "select * from manager.videos";
